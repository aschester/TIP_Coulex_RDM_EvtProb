  ...
  if(NbHits>0)
    {
       ...
       for (i=0;i<NbHits-1;i++) 
	 {
	   ...
	   if ((*ionCollection)[i]->GetVolName()=="backing"&&(*ionCollection)[i+1]->GetVolName()=="target")
	     (*ionCollection)[i+1]->SetTargetInFlag();
	   if ((*ionCollection)[i]->GetVolName()=="expHall"&&(*ionCollection)[i+1]->GetVolName()=="degrader")
	     (*ionCollection)[i+1]->SetDegraderInFlag();
	   if ((*ionCollection)[i]->GetVolName()=="degrader"&&(*ionCollection)[i+1]->GetVolName()=="degrader")
       ...
       for (i=1;i<NbHits;i++) 
	 {
	   ...
	   if ((*ionCollection)[i-1]->GetVolName()=="target"&&(*ionCollection)[i]->GetVolName()=="backing")
	     (*ionCollection)[i]->SetTargetOutFlag();
	   if ((*ionCollection)[i-1]->GetVolName()=="backing"&&(*ionCollection)[i]->GetVolName()=="expHall")
	     (*ionCollection)[i]->SetBackingOutFlag();
	   if ((*ionCollection)[i-1]->GetVolName()=="degrader"&&(*ionCollection)[i]->GetVolName()=="expHall")
