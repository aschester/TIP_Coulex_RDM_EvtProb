...
void SteppingAction::UserSteppingAction(const G4Step* aStep)
{
  ...
  // G4cout << "Volume name is "<< volname << G4endl;
 ...
 // printf("weight %f\n",weight);
  ...
  // G4cout << "Momentum = " << std::setprecision(6) << aStep->GetTrack()->GetMomentum() << G4endl;
  // G4cout << "Beta = " << std::setprecision(6) << aStep->GetPostStepPoint()->GetBeta() << G4endl;
  // G4cout << "Energy = " << std::setprecision(6) << aStep->GetTrack()->GetKineticEnergy() << G4endl;
  // getc(stdin);
